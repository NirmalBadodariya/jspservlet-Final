...
public interface AdminDaoInterface {
    ...
    public static final String userDetailsQuery = "select  users.id, users.firstname , users.email from users inner join assignned_roles on users.id = assignned_roles.u_id where assignned_roles.role=1; ";
